...
The simulation will start after you acknowledge. I can talk to you in the first text line, but the rest are simulated input. But you must not reply to me, just simulate. Current time is ''' + ctime()
